...
# - the raw per-macroblock ymode map dumped by the encoder
#
...
make -s all enc_pngdump enc_m09_modeenc >/dev/null

QUALS="0 10 50 75 90 100"
TMP_WEBP=build/enc_m09_modeenc_tmp.webp
TMP_PNG=build/enc_m09_modeenc_tmp.png
TMP_MODES=build/enc_m09_modeenc_tmp.modes
