...
void vp8_filter_mb_h_edge_sse2(uint8_t* src_q0, int stride, int edge_limit, int interior_limit, int hev_threshold) {
	...
	const __m128i p3 = _mm_loadu_si128((const __m128i*)(src_q0 - 4 * stride));
	const __m128i p2 = _mm_loadu_si128((const __m128i*)p2_ptr);
	...
	const __m128i q2 = _mm_loadu_si128((const __m128i*)q2_ptr);
	const __m128i q3 = _mm_loadu_si128((const __m128i*)(src_q0 + 3 * stride));
	...
	_mm_storeu_si128((__m128i*)p2_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, p2, mb_p2), p2));
	_mm_storeu_si128((__m128i*)p1_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, p1, mb_p1), p1));
	_mm_storeu_si128((__m128i*)p0_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, outer_p0, mb_p0), p0));
	_mm_storeu_si128((__m128i*)q0_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, outer_q0, mb_q0), q0));
	_mm_storeu_si128((__m128i*)q1_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, q1, mb_q1), q1));
	_mm_storeu_si128((__m128i*)q2_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, q2, mb_q2), q2));
}
...
void vp8_filter_subblock_h_edge_sse2(uint8_t* src_q0,
	...
	const __m128i p3 = _mm_loadu_si128((const __m128i*)(src_q0 - 4 * stride));
	const __m128i p2 = _mm_loadu_si128((const __m128i*)(src_q0 - 3 * stride));
	const __m128i p1 = _mm_loadu_si128((const __m128i*)p1_ptr);
	const __m128i p0 = _mm_loadu_si128((const __m128i*)p0_ptr);
	const __m128i q0 = _mm_loadu_si128((const __m128i*)q0_ptr);
	const __m128i q1 = _mm_loadu_si128((const __m128i*)q1_ptr);
	const __m128i q2 = _mm_loadu_si128((const __m128i*)(src_q0 + 2 * stride));
	const __m128i q3 = _mm_loadu_si128((const __m128i*)(src_q0 + 3 * stride));
	const __m128i threshold = normal_threshold_mask_sse2(p3, p2, p1, p0, q0, q1, q2, q3, edge_limit, interior_limit);
	const __m128i hev = hev_mask_sse2(p1, p0, q0, q1, hev_threshold);
	...
	_mm_storeu_si128((__m128i*)p1_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, p1, no_p1), p1));
	_mm_storeu_si128((__m128i*)p0_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, outer_p0, no_p0), p0));
	_mm_storeu_si128((__m128i*)q0_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, outer_q0, no_q0), q0));
	_mm_storeu_si128((__m128i*)q1_ptr, select_u8_sse2(threshold, select_u8_sse2(hev, q1, no_q1), q1));
}
